 ...
 * @author apprentice
 */
public class FlooringMasteryDAODemo implements FlooringMasteryInterface{
    ...
    /**
     * @param stateTaxList the stateTaxList to set
     */
