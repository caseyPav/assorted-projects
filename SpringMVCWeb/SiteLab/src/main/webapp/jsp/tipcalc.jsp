        ...
        <div class="container">
            <div class="content-section text-center">
                ...
                <div class="col-md-4">
                    ...
                    <h5>
                        welcome to tip calculator. <br><br>prepare to calculate tips
                    </h5>
                    <form class="form-horizontal" action="${pageContext.request.contextPath}/SiteLab/tipdrill"  method="POST">
                        <div>
                        <label class="formlabel">
                            Check Total 
                        </label>
                        <input type="number" name="userCheck" min="1" max="10000" data-bind="value:replyNumber" id="textbox"/>
                        </div><br><br>
                        <div>
                        <label class="formlabel">
                            Percentage Tip
                        </label>
                        <input type="number" name="userTip" min="1" max="10000" data-bind="value:replyNumber" id="textbox"/>
                        </div>
                        <br><br><br>
                        <button type="submit" value="${pageContext.request.contextPath}/SiteLab/tipdrill" class="btn btn-default">
                            Calculate Stuff
                        </button>
