        ...
        <div class="container">
            <div class="content-section text-center">
                ...
                <div class="col-md-4">
                    ...
                    <h5>
                        for all of your interest calculating needs. <br><br>
                    </h5>
                    <form class="form-horizontal" action="${pageContext.request.contextPath}/SiteLab/domath" name="senddata" method="POST">
                        <label form="userPrincipal" class="formlabel">
                            Initial Investment
                        </label>
                        <input type="number" name="userPrincipal" min="1" max="10000000" data-bind="value:replyNumber" id="textbox"/>
                        <br/><br/>
                        <label form="userInterest" class="formlabel">
                            Interest Rate Percent  
                        </label>
                        <input type="number" name="userInterest" min="0" max="100" data-bind="value:replyNumber" id="textbox"/>
                        <br/><br/>
                        <label form="userYears" class="formlabel">
                            Years To Invest  
                        </label>
                        <input type="number" name="userYears" min="1" max="100000000" data-bind="value:replyNumber" id="textbox"/>
                        <br/><br/><br/>
                        <button type="submit" value="${pageContext.request.contextPath}/SiteLab/domath" class="btn btn-default">
                            Get Results  
                        </button>
