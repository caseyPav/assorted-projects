        ...
        <div class="container">
            <div class="content-section text-center">
                ...
                <div class="col-md-4">
                    <h1>Lucky Sevens</h1>  
                    <h5>
                        welcome to lucky sevens. <br><br>prepare to lose all of your money
                    </h5>
                    <form class="form-horizontal" action="${pageContext.request.contextPath}/SiteLab/throwawaymoney" name="userBet" method="POST">
                        <label class="formlabel">
                            User Bet
                        </label>
                        <input type="number" name="userBet" min="1" max="10000" data-bind="value:replyNumber" id="textbox"/>
                        <br><br><br>
                        <button type="submit" name="userBet" class="btn btn-default">
                            Play
                        </button>
