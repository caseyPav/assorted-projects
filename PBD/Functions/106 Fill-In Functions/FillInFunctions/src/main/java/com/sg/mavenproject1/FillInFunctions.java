...
public class FillInFunctions {
    ...
    public static void credits(boolean credits) {
        if (credits = true) // displays some boilerplate text saying who wrote this program, etc.
        {
            System.out.println();
        }
	...
	public static char randchar( char random )
	// No parameters.
	{
